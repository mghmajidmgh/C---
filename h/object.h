...
namespace Ctriplus
{
    enum OBJECT_TYPE{CHAR,INT,LONG_LONG,DOUBLE,LONG_DOUBLE,STRING,ARRAY,OBJECT};
    ...
    class object
    {
        ...
        void convertToObject(){type=OBJECT_TYPE::OBJECT; map_ptr= std::make_shared< map<string,object>>();}
